...
class ActividadSospechosa extends StatefulWidget {
  const ActividadSospechosa({Key key}) : super(key: key);

  @override
  State<ActividadSospechosa> createState() => _ActividadSospechosaState();
}

class _ActividadSospechosaState extends State<ActividadSospechosa> {
  Position _position;
