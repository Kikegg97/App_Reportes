...
class RoboVehiculo extends StatefulWidget {
  const RoboVehiculo({Key key}) : super(key: key);

  @override
  State<RoboVehiculo> createState() => _RoboVehiculoState();
}

class _RoboVehiculoState extends State<RoboVehiculo> {
  Position _position;
