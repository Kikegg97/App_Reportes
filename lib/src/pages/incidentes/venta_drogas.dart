...
class VentaDrogas extends StatefulWidget {
  const VentaDrogas({Key key}) : super(key: key);

  @override
  State<VentaDrogas> createState() => _VentaDrogasState();
}

class _VentaDrogasState extends State<VentaDrogas> {
  Position _position;
